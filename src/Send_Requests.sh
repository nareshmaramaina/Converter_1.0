...
do
	...
	then
		curl --cacert /vision/curl-ca-bundle.crt https://rhms2.callippus.co.uk/api/FirmwareStatus?serialNo=111817161556  > /opt/Firmware_response.xml
Extracted Successfully in /etc/vision/RHMS/Firmware/ServerFirmwareRelease.info
curl --cacert /vision/curl-ca-bundle.crt https://rhms2.callippus.co.uk/api/ApplicationStatus?serialNo=111817161556  > /opt/Application_response.xml
